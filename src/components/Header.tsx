          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex flex-shrink-0 items-center">
                <Image className="block h-8 w-auto lg:hidden" width={32} height={32} src="/icon/icon-32x32.png" alt="MyIcon" />
                <Image className="hidden h-8 w-auto lg:block" width={32} height={32} src="/icon/icon-32x32.png" alt="MyIcon" />
              </div>
              ...
              <div className="relative ml-3">
                <div>
                  <button type="button" className="flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                    ...
                    <Image className="h-8 w-8 rounded-full" width={32} height={32} src="/icon/icon-32x32.png" alt="icon" />
                  </button>
                </div>
